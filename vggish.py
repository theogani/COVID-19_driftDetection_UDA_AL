...
# weight path
WEIGHTS_PATH = os.path.join('/home', 'biosim', 'Smarty', 'vggish_audioset_weights_without_fc2.h5')
WEIGHTS_PATH_TOP = os.path.join('/home', 'biosim', 'Smarty', 'vggish_audioset_weights.h5')
